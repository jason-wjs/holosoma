...
from holosoma.config_values.loco.g1.action import g1_29dof_joint_pos, g1_29dof_joint_target_mjlab
...
DEFAULTS = {
    ...
    "g1_29dof_joint_target_mjlab": g1_29dof_joint_target_mjlab,
}
