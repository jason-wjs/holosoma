"""Locomotion observation presets for the Adam Pro robot."""

from holosoma.config_types.observation import ObservationManagerCfg, ObsGroupCfg, ObsTermCfg

adam_pro_29dof_loco_single_wolinvel = ObservationManagerCfg(
    groups={
...
__all__ = ["adam_pro_29dof_loco_single_wolinvel"]
