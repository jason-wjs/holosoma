"""Locomotion randomization presets for the Adam Pro robot."""

from holosoma.config_types.randomization import RandomizationManagerCfg, RandomizationTermCfg

adam_pro_29dof_randomization = RandomizationManagerCfg(
    setup_terms={
...
__all__ = ["adam_pro_29dof_randomization"]
