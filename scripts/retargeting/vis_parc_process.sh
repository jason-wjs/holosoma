...
#   --object_urdf /tmp/parc_process_workspace/workspace/platform_001/multi_boxes_scaled_0.78_0.78_0.78.urdf \
...
python viser_player.py \
  --robot_urdf "${ROBOT_URDF}" \
  --object_urdf /tmp/parc_process_workspace/workspace/mid_blocks_004_dm/multi_boxes_scaled_0.78_0.78_0.78.urdf \
